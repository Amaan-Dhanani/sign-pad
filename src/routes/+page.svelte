...
<form method="POST" class="w-full max-w-2xl">
	...
	<!--
		Not reactive.
		This prevents the signature pad from being recreated
		whenever a stroke is added.
	-->
	<input
		bind:this={pathInput}
		type="hidden"
	...
	<div class="mt-4 flex justify-end gap-2">
		<button
			...
			class="rounded bg-blue-600 px-6 py-2 text-sm font-medium text-white hover:bg-blue-700 disabled:cursor-not-allowed disabled:opacity-50"
		>
			Submit
		</button>
		...
		<a
			...
			class="flex items-center justify-center rounded border border-gray-200 p-2 text-gray-600 hover:bg-gray-100"
		>
			<svg
